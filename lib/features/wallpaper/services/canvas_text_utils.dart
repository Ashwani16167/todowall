...
class WallpaperCanvasUtils {
  ...
  static TextPainter text(String content, Color color, double fontSize, String fontFamily,
      FontWeight weight, {TextAlign align = TextAlign.left, double? maxWidth}) {
    final tp = TextPainter(
      text: TextSpan(text: content, style: TextStyle(color: color, fontSize: fontSize, fontFamily: fontFamily, fontWeight: weight)),
      textAlign: align, textDirection: TextDirection.ltr,
      ellipsis: maxWidth != null ? '…' : null, maxLines: 1,
    );
