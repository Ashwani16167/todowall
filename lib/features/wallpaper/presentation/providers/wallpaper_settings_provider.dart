...
final wallpaperSettingsRepositoryProvider = Provider<WallpaperSettingsRepository>(
    (ref) => WallpaperSettingsRepositoryImpl(ref.watch(wallpaperSettingsBoxProvider)));
...
final wallpaperSettingsControllerProvider = Provider<WallpaperSettingsController>(
    (ref) => WallpaperSettingsController(ref.watch(wallpaperSettingsRepositoryProvider)));
...
class WallpaperSettingsController {
  ...
  Future<void> update(WallpaperSettingsModel Function(WallpaperSettingsModel) fn) => _repo.saveSettings(fn(current));
